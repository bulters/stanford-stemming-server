...
public class CoreAnnotations {
   ...
   * It standardly indexes from 1 (like IndexAnnotation).
   */
   ...
   * tree.  See {@link Tree#indexSpans(int)}. This annotation counts
   * tokens.  It standardly indexes from 1 (like IndexAnnotation).
