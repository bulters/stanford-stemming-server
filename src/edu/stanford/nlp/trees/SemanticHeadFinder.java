...
public class SemanticHeadFinder extends ModCollinsHeadFinder {
  ...
  private void ruleChanges() {
    ...
    nonTerminalInfo.put("WHNP", new String[][]{{"rightdis", "NN", "NNP", "NNPS", "NNS", "NX", "NML", "JJR", "WP"}, {"left", "NP", "WHNP"}, {"rightdis", "$", "ADJP", "PRN", "FW"}, {"right", "CD"}, {"rightdis", "JJ", "JJS", "RB", "QP"}, {"left", "WHPP", "WHADJP", "WP$", "WDT"}});
    //WHADJP
  ...
  private boolean vpContainsParticiple(Tree t) {
